        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Your Subscriptions", style: TextStyle(fontSize: 18, fontWeight: FontWeight.normal, color: Colors.black),),
                GestureDetector(
                    onTap: () {},
                    child: Text("See More", style: TextStyle(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.black,),),),
              ],
            ),
          ),
